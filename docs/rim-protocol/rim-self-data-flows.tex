...
Every piece in a capsule is authorized to read and write every flow that any piece in
that capsule can access; a capsule represents a single person's equivalent gateways to
their data, and adding a new piece to a capsule immediately grants it the same access
as all existing pieces.
