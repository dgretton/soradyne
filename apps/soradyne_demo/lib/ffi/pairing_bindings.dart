...
typedef SoradynePairingDeleteCapsuleC = Int32 Function(Pointer<Utf8>);
typedef SoradynePairingDeleteCapsule = int Function(Pointer<Utf8>);
...
class PairingBindings {
  ...
  late final SoradynePairingDeleteCapsule _deleteCapsule;
  ...
  PairingBindings() {
    ...
    _deleteCapsule = _lib.lookupFunction<SoradynePairingDeleteCapsuleC,
        SoradynePairingDeleteCapsule>('soradyne_pairing_delete_capsule');
  ...
  /// Delete a capsule by UUID. Returns 0 on success, -1 on error.
  int deleteCapsule(String capsuleId) {
    final idPtr = capsuleId.toNativeUtf8();
    try {
      return _deleteCapsule(idPtr);
    } finally {
      malloc.free(idPtr);
    }
  }
