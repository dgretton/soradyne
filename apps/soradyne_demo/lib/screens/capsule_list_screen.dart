  ...
  void _confirmDelete(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'This permanently removes "${capsule.name}" from this device. '
          'Other devices in the capsule are unaffected.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx),
          ...
          TextButton(
            ...
            onPressed: () {
              ...
              context.read<PairingService>().deleteCapsule(capsule.id);
            },
          ...
          child: ListView(
            ...
            children: [
              ...
              OutlinedButton.icon(
                ...
                label: const Text('Delete Capsule'),
